...
public class TimerCommandHandler(IStringLocalizer<TimerCommandHandler> localizer, ClientState clientState, ClientSettings settings, IAudioPlayer audioPlayer)
{
    #region Injects
    protected readonly IStringLocalizer<TimerCommandHandler> Localizer = localizer;
    ...
    protected Task<ClientActionResponse> HandleSetTimerCommandAsync(TimerActionArgs args)
    {
        ...
        {
            AudioPlayer.PlayAsync(SoundEffect.TimerRingtone);
